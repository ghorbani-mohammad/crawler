...
PROJECT_NAME='crawler_v2'
SERVER_NAME='germany1'
PROJECT_PATH='/var/www/crawler_v2/'
...
NGINX_FILE='crawler_v2_api_nginx.conf'
...
function issue_https_certificate() {
    sudo certbot --nginx certonly -d crawler_v2.m-gh.com
